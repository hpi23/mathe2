...
$\varphi(n)$ Aussage über natürliche Zahl $n$. Zu zeigen $\forall n \in \natnum\colon \; \varphi(n)$.

Induktionsbeginn (IB) Zeige: $\varphi(0)$.

Induktionsvoraussetzung (IV) Sei $n \in \natnum$. Nimm an $\varphi(n)$.

Induktionsschritt (IS) Zeige nun $\varphi(n+1)$. 
